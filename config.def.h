...
static const char *fonts[]          = { "Victor Mono:style=SemiBold:size=9",
	"JoyPixels:style=Regular:size=8:antialias=true:autohint=true",
	"DejaVu Sans" };
...
static const char *bookscmd[] = { "openbook", "-nb", col_gray1, "-nf",
	col_gray3, "-sb", col_darkmagenta, "-sf", col_gray4, NULL };
...
static const char *systemsleep[]  = { "systemsleep", NULL };

static const char scratchpadname[] = "scratchpad";
static const char *scratchpadcmd[] = { "kitty", "--title", scratchpadname,
	"--class", "scratchpad", "--session",
	"/home/mk/.config/kitty/sessions/scratchpad", NULL };
...
static Key keys[] = {
	...
	{ MOD2KEY,             XK_space,      spawn,          {.v = switchkblayout }},
	{ MODKEY,              XK_x,          spawn,          {.v = lockscreen }},
	{ MODKEY|ShiftMask,    XK_x,          spawn,          {.v = systemsleep }},
